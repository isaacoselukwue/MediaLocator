...
using ML.Application.FunctionalTests.Helpers;

namespace ML.Application.FunctionalTests.Accounts.Queries;
    ...
    private static List<UserAccountResult> GetTestUserAccounts(int count)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            results.Add(new UserAccountResult
            {
                ...
                DateAccountCreated = DateTimeOffset.UtcNow.AddDays(-i),
